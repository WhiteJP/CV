...
My attempts at creating a CV(s) using R packages 'pagedown' and 'VisualResume`.
...
```{r, fig.width=8.5, fig.height=11, warning= FALSE, message=FALSE}
...
VisualResume(
  ...
  events = data.frame(
    ...
    title = c("Top 10% of graduating LLB/BCom students",
              "3:36 Gold Coast Marathon,\nand completed RiverRun UltraMarathon",
              "Valedictorian of UniMelb GradDip Psychology",
              "Valedict. of UniMelb GradDip (Adv) Psychology",
              "First Published Academic Paper\ndoi: 10.1371/journal.pone.0251964")),
  interests = 
    list(
      "Programming" = c(rep("R", 10), rep("DataVis", 6), rep("JavaScript", 2), "Python"),
      "Statistics" = c(rep("ML", 1), rep("Regression", 1), rep("Bayes", 7)),
      "Psychology" = c(rep("Cog", 3), rep("MathPsych", 2), rep("Decision-making", 3))),
  year.steps = 1
)
```
